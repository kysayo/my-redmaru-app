...
export const DEFAULT_AI_ANSWER_CLOSED_TEMPLATE =
  'これは対応完了したRedmineチケットの本文と変更履歴のテキストです。あなたの回答はそのままRedmineのカスタムフィールドに保存されるため、前置き・挨拶・Markdown装飾（見出しや箇条書き記号など）を使わず、以下の段落を使って内容をまとめてください。チケットはQA/BUG/Change Request/Enhanceと種類が分かれるため、該当する情報がない場合もあります。その場合は情報の無い段落は記載しないでください。\n\n・問い合わせ概要\n・事象\n・原因\n・影響範囲\n・対応内容\n・ユーザ対応\n・結果';
